...
We construct the Dolgachev--Nikulin dual lattice to the Picard lattice of a general anticanonical section for any smooth Fano threefold in Mori--Mukai classification, following ``Dolgachev--Nikulin duality for fibers of toric Landau--Ginzburg models of smooth Fano threefolds'' by Doran--Harder--Katzarkov--Ovcharenko--Przyjalkowski (to be published).
...
For families no. 2.34, 3.27, 3.28, 4.11, 5.3, 6.1, 7.1, and 8.1 there is also available the parametrised version of the construction, i.e., the construction for a general fiber of the toric Landau--Ginzburg model for a pair (X, D). The corresponding command is

`sage ./Reports/parametrised/rank-familyno.sage`

e.g.,

`sage ./Reports/parametrised/03-27.sage`
