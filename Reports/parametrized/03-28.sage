load("Library.sage")
load("Data/parametrized/03-28/setup.sage")
load("Data/parametrized/03-28/pencil.sage")
load("Data/parametrized/03-28/resolution.sage")
load("Data/parametrized/03-28/lattice.sage")
