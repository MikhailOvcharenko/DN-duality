load("Library.sage")
load("Data/parametrized/08-01/setup.sage")
load("Data/parametrized/08-01/pencil.sage")
load("Data/parametrized/08-01/resolution.sage")
load("Data/parametrized/08-01/lattice.sage")
