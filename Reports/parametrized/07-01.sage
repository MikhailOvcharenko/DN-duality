load("Library.sage")
load("Data/parametrized/07-01/setup.sage")
load("Data/parametrized/07-01/pencil.sage")
load("Data/parametrized/07-01/resolution.sage")
load("Data/parametrized/07-01/lattice.sage")
