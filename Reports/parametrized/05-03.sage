load("Library.sage")
load("Data/parametrized/05-03/setup.sage")
load("Data/parametrized/05-03/pencil.sage")
load("Data/parametrized/05-03/resolution.sage")
load("Data/parametrized/05-03/lattice.sage")
