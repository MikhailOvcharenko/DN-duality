load("Library.sage")
load("Data/parametrized/03-27/setup.sage")
load("Data/parametrized/03-27/pencil.sage")
load("Data/parametrized/03-27/resolution.sage")
load("Data/parametrized/03-27/lattice.sage")
