load("Library.sage")
load("Data/parametrized/02-34/setup.sage")
load("Data/parametrized/02-34/pencil.sage")
load("Data/parametrized/02-34/resolution.sage")
load("Data/parametrized/02-34/lattice.sage")
