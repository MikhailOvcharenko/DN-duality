load("Library.sage")
load("Data/parametrized/06-01/setup.sage")
load("Data/parametrized/06-01/pencil.sage")
load("Data/parametrized/06-01/resolution.sage")
load("Data/parametrized/06-01/lattice.sage")
