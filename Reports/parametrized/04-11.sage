load("Library.sage")
load("Data/parametrized/04-11/setup.sage")
load("Data/parametrized/04-11/pencil.sage")
load("Data/parametrized/04-11/resolution.sage")
load("Data/parametrized/04-11/lattice.sage")
