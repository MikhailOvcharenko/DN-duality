load("Library.sage")
load("Data/parametrised/08-01/setup.sage")
load("Data/parametrised/08-01/pencil.sage")
load("Data/parametrised/08-01/resolution.sage")
load("Data/parametrised/08-01/lattice.sage")
