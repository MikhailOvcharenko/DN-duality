load("Library.sage")
load("Data/parametrised/05-03/setup.sage")
load("Data/parametrised/05-03/pencil.sage")
load("Data/parametrised/05-03/resolution.sage")
load("Data/parametrised/05-03/lattice.sage")
