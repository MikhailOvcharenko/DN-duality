load("Library.sage")
load("Data/parametrised/03-28/setup.sage")
load("Data/parametrised/03-28/pencil.sage")
load("Data/parametrised/03-28/resolution.sage")
load("Data/parametrised/03-28/lattice.sage")
