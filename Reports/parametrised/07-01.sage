load("Library.sage")
load("Data/parametrised/07-01/setup.sage")
load("Data/parametrised/07-01/pencil.sage")
load("Data/parametrised/07-01/resolution.sage")
load("Data/parametrised/07-01/lattice.sage")
