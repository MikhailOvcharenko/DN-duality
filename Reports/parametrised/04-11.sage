load("Library.sage")
load("Data/parametrised/04-11/setup.sage")
load("Data/parametrised/04-11/pencil.sage")
load("Data/parametrised/04-11/resolution.sage")
load("Data/parametrised/04-11/lattice.sage")
