load("Library.sage")
load("Data/parametrised/02-34/setup.sage")
load("Data/parametrised/02-34/pencil.sage")
load("Data/parametrised/02-34/resolution.sage")
load("Data/parametrised/02-34/lattice.sage")
