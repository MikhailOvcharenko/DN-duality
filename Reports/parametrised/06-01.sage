load("Library.sage")
load("Data/parametrised/06-01/setup.sage")
load("Data/parametrised/06-01/pencil.sage")
load("Data/parametrised/06-01/resolution.sage")
load("Data/parametrised/06-01/lattice.sage")
