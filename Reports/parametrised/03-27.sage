load("Library.sage")
load("Data/parametrised/03-27/setup.sage")
load("Data/parametrised/03-27/pencil.sage")
load("Data/parametrised/03-27/resolution.sage")
load("Data/parametrised/03-27/lattice.sage")
