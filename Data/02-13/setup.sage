...
fano_threefold_picard_lattice = matrix(ZZ, ((2, 6),
                                            (6, 6)));
...
LG_model = x + y + z + x^-1*y*z + x*y^-1 + 2*x^-1*y + y^-1*z + x*y^-1*z^-1 + \
    2*z^-1 + x^-1*y*z^-1 + 2*y^-1 + y^-1*z^-1;
LG_model_polytope_PALP_ID = 1393;
LG_model_period_sequence_GRDB_ID = 119;
