...
fano_threefold_picard_lattice = matrix(ZZ, ((2, 4),
                                            (4, 2)));
...
LG_model = x + y + x*y^-1*z + 2*z + x^-1*y*z + y^-1*z^2 + x^-1*z^2 + x*z^-1 + \
    y*z^-1 + 2*x*y^-1 + 2*x^-1*y + 3*y^-1*z + 3*x^-1*z + x*y^-1*z^-1 + \
    2*z^-1 + x^-1*y*z^-1 + 3*y^-1 + 3*x^-1 + y^-1*z^-1 + x^-1*z^-1;
LG_model_polytope_PALP_ID = 3874;
LG_model_period_sequence_GRDB_ID = 149;
LG_model_period_sequence_PFO_degree = 3;
