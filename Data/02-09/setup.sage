...
fano_threefold_family_no = 9;
fano_threefold_picard_lattice = matrix(ZZ, ((8, 7),
                                            (7, 4)));
...
LG_model = x + y + z + x*z^-1 + y*z^-1 + x*y^-1 + x^-1*y + 2*y^-1*z + \
    2*x^-1*z + x^-1*y^-1*z^2 + x*y^-1*z^-1 + 2*z^-1 + x^-1*y*z^-1 + 2*y^-1 + \
    2*x^-1 + x^-1*y^-1*z;
LG_model_polytope_PALP_ID = 3014;
