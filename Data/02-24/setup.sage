...
fano_threefold_family_no = 24;
fano_threefold_picard_lattice = matrix(ZZ, ((2, 5),
                                            (5, 2)));
...
LG_model = x*y*z^-1 + x + y + z + x*z^-1 + x^-1*y + y^-1*z + y^-1 + x^-1;
LG_model_polytope_PALP_ID = 412;
LG_model_period_sequence_GRDB_ID = 44;
