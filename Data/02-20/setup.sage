...
fano_threefold_family_no = 20;
fano_threefold_picard_lattice = matrix(ZZ, ((-2, 3),
                                            (3, 10)));
...
LG_model = x + y + x*y^-1*z + z + y*z^-1 + x^-1*y + z^-1 + x^-1*y*z^-1 + \
    y^-1 + x^-1 + x^-1*z^-1;
LG_model_polytope_PALP_ID = 1110;
LG_model_period_sequence_GRDB_ID = 87;
