...
fano_threefold_picard_lattice = matrix(ZZ, ((-2, 2, 1),
                                            (2, 0, 3),
                                            (1, 3, 2)));
...
LG_model = x + y + z + y^-1*z + z^-1 + y^-1 + x^-1 + x^-1*y^-1*z;
LG_model_polytope_PALP_ID = 214;
LG_model_period_sequence_GRDB_ID = 49;
