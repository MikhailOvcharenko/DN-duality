...
fano_threefold_family_no = 13;
fano_threefold_picard_lattice = matrix(ZZ, ((-2, 2, 2),
                                            (2, 2, 4),
                                            (2, 4, 2)));
...
LG_model = x + y + z + y*z^-1 + x*y^-1 + x^-1*z + z^-1 + y^-1 + x^-1;
LG_model_polytope_PALP_ID = 421;
LG_model_period_sequence_GRDB_ID = 70;
