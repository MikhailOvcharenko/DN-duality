...
fano_threefold_picard_lattice = matrix(ZZ, ((-2, 0, 1),
                                            (0, 0, 4),
                                            (1, 4, 4)));
...
LG_model = x + 2*y + x^-1*y^2 + z + x^-1*y*z + x*z^-1 + y*z^-1 + 3*x^-1*y + \
    x^-1*z + z^-1 + y^-1 + 3*x^-1 + x^-1*y^-1;
LG_model_polytope_PALP_ID = 1900;
LG_model_period_sequence_GRDB_ID = 117;
