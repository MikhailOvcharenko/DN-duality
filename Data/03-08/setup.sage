...
fano_threefold_picard_lattice = matrix(ZZ, ((2, 0, 5),
                                            (0, -2, 2),
                                            (5, 2, 2)));
...
LG_model = x + y + x*y^-1*z + z + x*y^-1 + x^-1*y + y^-1*z + z^-1 + 2*y^-1 + \
    2*x^-1 + x^-1*z^-1 + x^-1*y^-1;
LG_model_polytope_PALP_ID = 1505;
LG_model_period_sequence_GRDB_ID = 112;
