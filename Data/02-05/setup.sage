...
LG_model = x + y + z + x^2*y^-1*z^-1 + 3*x*z^-1 + 3*y*z^-1 + x^-1*y^2*z^-1 + \
    3*x*y^-1 + 3*x^-1*y + 3*y^-1*z + 3*x^-1*z + x^-1*y^-1*z^2 + x*y^-1*z^-1 + \
    2*z^-1 + x^-1*y*z^-1 + 2*y^-1 + 2*x^-1 + x^-1*y^-1*z;
LG_model_polytope_PALP_ID = 3453;
LG_model_period_sequence_GRDB_ID = 158;
