...
LG_model = x + y + z + x*y^-1 + x^-1*y + y^-1*z + x^-1*z + z^-1 + 2*y^-1 + \
    x^-1 + x^-1*y^-1*z + x^-1*z^-1 + x^-1*y^-1;
LG_model_polytope_PALP_ID = 1927;
LG_model_period_sequence_GRDB_ID = 101;
