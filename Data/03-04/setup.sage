...
fano_threefold_picard_lattice = matrix(ZZ, ((-2, 2, 0),
                                            (2, 0, 4),
                                            (0, 4, 2)));
...
LG_model = x + y + x*y^-1*z + 2*z + x^-1*y*z + 2*x*y^-1 + 2*x^-1*y + x^-1*z + \
    x*y^-1*z^-1 + 2*z^-1 + x^-1*y*z^-1 + 2*x^-1 + x^-1*z^-1;
LG_model_polytope_PALP_ID = 1725;
LG_model_period_sequence_GRDB_ID = 142;
