...
pencil_base_locus_components = (CR_flattened.ideal(X, Y),
                                ...
                                CR_flattened.ideal(Z, (X + Y)^2 + Y*T),
...
pencil_AS_integral_generators = (1, 2, 4, 5, 6);
