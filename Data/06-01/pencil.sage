...
pencil_base_locus_components = (CR_flattened.ideal(X, Z),
                                ...
                                CR_flattened.ideal(T, (X + Y)^2 + X*Z));
...
pencil_AS_integral_generators = (3, 4, 5, 8);

# Auxiliary ramified covering of the projective line (l = ...)
pencil_generic_member_base_field_extension = - 1 + 1/(m*(m - 1));
