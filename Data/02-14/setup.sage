...
fano_threefold_family_no = 14;
fano_threefold_picard_lattice = matrix(ZZ, ((0, 5),
                                            (5, 10)));
...
LG_model = x*y*z^-1 + x + z + 2*y*z^-1 + x^-1*z + x^-1*y^-1*z^2 + 2*z^-1 + \
    x^-1*y*z^-1 + 3*x^-1 + 3*x^-1*y^-1*z + 2*x^-1*z^-1 + 3*x^-1*y^-1 + \
    x^-1*y^-1*z^-1;
LG_model_polytope_PALP_ID = 1659;
LG_model_period_sequence_GRDB_ID = 122;
