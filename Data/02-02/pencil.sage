...
pencil_infinity_member_components = (CR_flattened.ideal(X),
                                     ...
                                     CR_flattened.ideal(Y*(X + Z) - T*(Z - T)));
...
pencil_base_locus_components = (CR_flattened.ideal(X, Z),
                                ...
                                CR_flattened.ideal(Y, Z*(X + T) - T^2),
                                CR_flattened.ideal(Z, X*Y + T^2));
...
pencil_general_member_singularities_types = (('A', 1), ('A', 9), ('E', 6));
