...
fano_threefold_picard_lattice = matrix(ZZ, ((-2, 0, 2),
                                            (0, -2, 2),
                                            (2, 2, 6)));
...
LG_model = x*y*z^-1 + x + y + z + x*z^-1 + y^-1*z + x^-1*z + z^-1 + y^-1 + \
    x^-1 + x^-1*y^-1*z;
LG_model_polytope_PALP_ID = 1113;
LG_model_period_sequence_GRDB_ID = 99;
