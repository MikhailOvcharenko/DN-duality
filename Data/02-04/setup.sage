...
LG_model = x^2*z^-1 + x*y*z^-1 + x^2*y^-1 + 4*x + 2*y + 2*x*y^-1*z + 4*z + \
    x^-1*y*z + y^-1*z^2 + x^-1*z^2 + 3*x*z^-1 + 2*y*z^-1 + 2*x*y^-1 + \
    2*x^-1*y + 2*y^-1*z + 3*x^-1*z + 3*z^-1 + x^-1*y*z^-1 + y^-1 + 3*x^-1 + \
    x^-1*z^-1;
LG_model_polytope_PALP_ID = 3964;
LG_model_period_sequence_GRDB_ID = 161;
