...
pencil_general_member_singularities_resolution_05_00 = \
    LabelledOrderedTree([], label = (2, (0, 0, 0, (l + 2)^-1)));
pencil_general_member_singularities_resolution_05_01 = \
    LabelledOrderedTree([], label = (3, (0, 0, l + 2, 0)));
...
pencil_general_member_singularities_resolution_06 = \
    LabelledOrderedTree([], label = (1, ((1 - m)/m, 0, 0, (m - 1))));

pencil_general_member_singularities_resolution_07 = \
    LabelledOrderedTree([], label = (0, (0, (1 - m)/m, 0, (m - 1))));
