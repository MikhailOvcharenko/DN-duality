...
fano_threefold_family_no = 12;
fano_threefold_picard_lattice = matrix(ZZ, ((4, 6), \
                                            (6, 4)));
...
LG_model = x*y*z^-1 + x + y + z + 2*x*z^-1 + 2*y*z^-1 + x*y^-1*z^-1 + 2*z^-1 + \
    x^-1*y*z^-1 + 2*y^-1 + 2*x^-1 + x^-1*y^-1*z;
LG_model_polytope_PALP_ID = 1194;
LG_model_period_sequence_GRDB_ID = 118;
