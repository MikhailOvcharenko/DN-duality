...
LG_model = y + z + x^-1*y*z + 2*x^-1*z^2 + x^-1*y^-1*z^3 + x*z^-1 + y*z^-1 + \
    2*x^-1*y + 2*y^-1*z + 2*x^-1*z + x*y^-1*z^-1 + 2*z^-1 + x^-1*y*z^-1;
LG_model_polytope_PALP_ID = 1701;
LG_model_period_sequence_GRDB_ID = 120;
