...
fano_threefold_picard_lattice = matrix(ZZ, ((-2, 0, 0),
                                            (0, 0, 3),
                                            (0, 3, 4)));
...
LG_model = x + y + z + x^2*y^-1*z^-1 + x^-1*y + x^-1*z + x*y^-1*z^-1 + x^-1;
LG_model_polytope_PALP_ID = 203;
LG_model_period_sequence_GRDB_ID = 21;
