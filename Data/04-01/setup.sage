...
fano_threefold_picard_lattice = matrix(ZZ, ((0, 2, 2, 2),
                                            (2, 0, 2, 2),
                                            (2, 2, 0, 2),
                                            (2, 2, 2, 0)));
...
LG_model = x + y + z + y*z^-1 + x^-1*y + y^-1*z + x^-1*z + z^-1 + \
    x^-1*y*z^-1 + y^-1 + 3*x^-1 + x^-1*y^-1*z + x^-1*z^-1 + x^-1*y^-1;
LG_model_polytope_PALP_ID = 2355;
LG_model_period_sequence_GRDB_ID = 111;
