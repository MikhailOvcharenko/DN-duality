...
LG_model = x + y + z + x^-1*y + x^-1*z + x*y^-1*z^-1 + z^-1 + y^-1 + x^-1 + \
    2*y^-1*z^-1 + x^-1*z^-1 + x^-1*y^-1 + x^-1*y^-1*z^-1;
LG_model_polytope_PALP_ID = 1923;
LG_model_period_sequence_GRDB_ID = 74;
