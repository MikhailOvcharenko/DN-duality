...
pencil_general_member_singularities_resolution_03_00 = \
    LabelledOrderedTree([], label = (0, (0, 0, 0, (l + 6)^-1)));
pencil_general_member_singularities_resolution_03_01 = \
    LabelledOrderedTree([], label = (3, (l + 6, 0, 0, 0)));
