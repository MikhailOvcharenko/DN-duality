...
fano_threefold_picard_lattice = matrix(ZZ, ((-2, 1, 3),
                                            (1, -2, 0),
                                            (3, 0, 4)));
...
LG_model = x + y + z + y*z^-1 + x*y^-1 + x^-1*y*z^-1 + y^-1 + x^-1;
LG_model_polytope_PALP_ID = 213;
LG_model_period_sequence_GRDB_ID = 42;
