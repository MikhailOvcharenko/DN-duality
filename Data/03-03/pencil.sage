...
pencil_base_locus_components = (CR_flattened.ideal(X, Z),
                                ...
                                CR_flattened.ideal(X, Y*(Z + T) + T^2),
                                CR_flattened.ideal(T, Z*(Y + X) + X^2));
...
pencil_AS_integral_generators = (1, 4, 5, 6, 7, 10);
...
pencil_general_member_singularities_types = (('A', 4), ('A', 4), ('A', 3));
