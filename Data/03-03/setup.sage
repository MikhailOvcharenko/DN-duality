...
fano_threefold_picard_lattice = matrix(ZZ, ((0, 2, 3),
                                            (2, 0, 3),
                                            (3, 3, 2)));
...
LG_model = x^2*z^-1 + 2*x + y + z + x^-1*y*z + 2*x*z^-1 + x*y^-1 + x^-1*y + \
    x^-1*z + z^-1 + 2*y^-1 + 2*x^-1 + x^-1*y^-1;
LG_model_polytope_PALP_ID = 1805;
LG_model_period_sequence_GRDB_ID = 135;
