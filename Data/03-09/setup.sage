...
fano_threefold_picard_lattice = matrix(ZZ, ((4, 8, 4),
                                            (8, 10, 5),
                                            (4, 5, 2)));
...
LG_model = x + y + z + x^2*y^-1*z^-1 + x^-1*y + x^-1*z + 2*x*y^-1*z^-1 + \
    x^-1 + y^-1*z^-1;
LG_model_polytope_PALP_ID = 374;
LG_model_period_sequence_GRDB_ID = 22;
