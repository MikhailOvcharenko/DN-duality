...
pencil_reducible_members_components = \
    (CR_flattened.ideal(l + 2, X + Z),
     CR_flattened.ideal(l + 2, Y + T),
     CR_flattened.ideal(l + 2, T*(X + Y + Z) + X*Z));
...
pencil_AS_integral_generators = (1, 3, 5, 6, 7, 12);
