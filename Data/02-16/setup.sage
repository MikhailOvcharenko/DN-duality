...
fano_threefold_family_no = 16;
fano_threefold_picard_lattice = matrix(ZZ, ((-2, 2),
                                            (2, 8)));
...
LG_model = x + z + x*z^-1 + y*z^-1 + x*y^-1 + x^-1*y + y^-1*z + x^-1*z + \
    x*y^-1*z^-1 + z^-1 + 2*y^-1 + x^-1 + x^-1*y^-1*z;
LG_model_polytope_PALP_ID = 1940;
LG_model_period_sequence_GRDB_ID = 104;
