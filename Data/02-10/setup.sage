...
fano_threefold_family_no = 10;
fano_threefold_picard_lattice = matrix(ZZ, ((0, 4),
                                            (4, 8)));
...
LG_model = x + y + 2*z + x^-1*y*z + x^-1*z^2 + x*z^-1 + x*y^-1 + x^-1*y + \
    y^-1*z + 3*x^-1*z + x*y^-1*z^-1 + 2*z^-1 + 2*y^-1 + 3*x^-1 + y^-1*z^-1 + \
    x^-1*z^-1;
LG_model_polytope_PALP_ID = 3019;
LG_model_period_sequence_GRDB_ID = 145;
