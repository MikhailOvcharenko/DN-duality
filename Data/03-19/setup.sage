...
fano_threefold_family_no = 19;
fano_threefold_picard_lattice = diagonal_matrix(ZZ, (-2, -2, 6));
...
LG_model = x + y + z + x^-1*z + x*y^-1*z^-1 + x^-1 + y^-1*z^-1;
LG_model_polytope_PALP_ID = 75;
LG_model_period_sequence_GRDB_ID = 18;
