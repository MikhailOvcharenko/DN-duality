...
fano_threefold_picard_lattice = matrix(ZZ, ((0, 1, 4),
                                            (1, -2, 0),
                                            (4, 0, 4)));
...
LG_model = x + y + z + y*z^-1 + x^-1*y + y^-1*z + x^-1*z + x^-1*y*z^-1 + \
    y^-1 + x^-1 + x^-1*y^-1*z + x^-1*y^-1;
LG_model_polytope_PALP_ID = 1519;
LG_model_period_sequence_GRDB_ID = 72;
