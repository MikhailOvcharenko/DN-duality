...
fano_threefold_picard_lattice = matrix(ZZ, ((-2, 0, 0, 1),
                                            (0, -2, 0, 1),
                                            (0, 0, -2, 1),
                                            (1, 1, 1, 4)));
...
LG_model = x + y + z + y^-1*z + z^-1 + y^-1 + x^-1 + x^-1*z^-1 + x^-1*y^-1;
LG_model_polytope_PALP_ID = 424;
LG_model_period_sequence_GRDB_ID = 65;
