...
fano_threefold_picard_lattice = matrix(ZZ, ((0, 2, 2, 4),
                                            (2, 0, 2, 3),
                                            (2, 2, 0, 3),
                                            (4, 3, 3, 6)));
...
LG_model = x + y + x*y^-1 + x^-1*y + y^-1*z + x^-1*z + 2*y^-1 + 2*x^-1 + \
    y^-1*z^-1 + x^-1*z^-1;
LG_model_polytope_PALP_ID = 664;
LG_model_period_sequence_GRDB_ID = 88;
