...
fano_threefold_picard_lattice = matrix(ZZ, ((-2, 1, 1, 3),
                                            (1, 0, 2, 2),
                                            (1, 2, 0, 2),
                                            (3, 2, 2, 0)));
...
LG_model = x + y + z + x*y^-1 + x^-1*y + x*y^-1*z^-1 + z^-1 + 2*y^-1 + \
    2*x^-1 + y^-1*z^-1 + x^-1*y^-1;
LG_model_polytope_PALP_ID = 1081;
LG_model_period_sequence_GRDB_ID = 110;
